<div align="center">
  ...
  <br />
    <div align="center">
        <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&width=435&lines=Muhammadrasul+Karimov;AI+Builder+%7C+Comp+Programmer;Presidential+School+Fergana+'26" alt="Typing SVG" /></a>
    </div>
</div>
...
<pre style="font-family:'Courier New', monospace; background:#0a0a0a; color:#00ff66; padding:15px; border:2px solid #00ff66; border-radius:10px;">
          ...
          ├──────────────────────────────┼─────────────────────────────┼──────────────────────────────┤
          │ • 1st — Eurasian Fibonacci   │ Languages:  C++, Python, JS │ • EcoLens (Edge AI)          │
          │   Robot Olympiad (Türkiye)   │ Web: HTML, CSS              │ • Paint Tool (C++)           │
          │ • 2× 2nd — Fibonacci Olymp.  │ AI/ML: YOLOv10, LLMs        │ • FindTheNumber (JS)         │
          │ • 2× 1st — Regional STEM &   │ Robotics: Arduino, Lego     │ • Dice Game (Logic)          │
          │   Informatics Olympiads      │ Tools: Git, Linux(WSL)      │ • RFID Money System          │
          │ • 2× 2nd — Regional Olymp.   │ Compiler: GCC -O3, Py       │ • School Website             │
          │ • 2nd — Robo-Coding Olymp.   │                             │                              │
          │ • SAT: 1530 | IELTS: 7.5     │ Uzbek C2 | English C1       │       [SEE BELOW FOR]        │
          │ • AS Pure Maths: A           │ Russian C1                  │       [DETAILED REPOS]       │
          └──────────────────────────────┴─────────────────────────────┴──────────────────────────────┘
          
          ┌─────────────────────────────────────────────────────────────────────────────────────────────┐
          │                                         ABOUT ME                                            │
          │─────────────────────────────────────────────────────────────────────────────────────────────│
          │  Competitive programmer and AI builder from Uzbekistan. I spend most of my time solving     │
          │  hard problems — on Codeforces, in olympiads, and in my own projects. Currently building    │
          │  edge AI systems that run locally, without cloud dependency. Applying to top AI research    │
          │  universities. Football defender off the keyboard.                                          │
          └─────────────────────────────────────────────────────────────────────────────────────────────┘
</pre>
  ...
  <table width="95%" style="border-collapse: separate; border-spacing: 12px;">
    <tr>
      <td width="50%" bgcolor="#f5f5f0" style="border: 1px solid #d1d1ca; border-radius: 12px; padding: 25px; text-align: left;">
          ...
          <p style="color: #444; font-size: 14px; line-height: 1.5;">On-device vision system for waste sorting. Optimized for Apple Silicon M4 with YOLOv10 + Llama 3.2 Vision.</p>
          <div style="margin-top: 10px;">
            <a href="https://github.com/KarimovMuhammadrasul/EcoLens"><img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" /></a>
...
<br/>
<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=KarimovMuhammadrasul&theme=tokyonight&hide_border=true&background=0a0a0a&ring=00ff66&fire=00ff66" height="170" />
</div>
